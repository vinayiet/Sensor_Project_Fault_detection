...
from src.logger import logger as lg  # Ensure logger is correctly defined in src.logger
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5001 , debug = True)  # Run the Flask application
